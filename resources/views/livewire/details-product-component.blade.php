...
<div class="container details_pr">
        ...
        <div class="single_product_desc">
            <h2 class="text_blue">{{$detailsProduct->name}}</h2>
            <p><h6 class="text_blue">Deskripsi Pendek: </h6>{{$detailsProduct->short_description}}</p>
            <p><h6 class="text_blue">Deskripsi: </h6>{{$detailsProduct->description}}</p>
            <h3 class="text_blue">Rp {{$detailsProduct->sale_price}}</h3>
            <p><span class="text_blue">Availability :</span>  {{$detailsProduct->stock_status}}</p>
    ...
    <div class="container">
        <h4 class="similer_head">Produk Yang Sejenis :</h4>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="product-grid">
                    ...
                    <div class="product-content">
                        ...
                        <div class="price">Rp {{$product_similer->sale_price}}
                            <span>Rp {{$product_similer->reguler_price}}</span>
                        </div>
