...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    @foreach ($slider as $slide)
      ...
      <div class="row align-items-center">
              <div class="col-6 desc_ban">
                ...
                <p>{{$slide->subtitle}}</p>
                <h2>Rp {{$slide->price}}</h2>
                <a type="button" class="btn btn_custom" href="{{$slide->link}}">Beli Sekarang</a>
              </div>
              <div class="col-md-5">
  ...
  <select name="" class="sort_product" wire:model="pagesize">
      ...
      <option value="4">4 item per page</option>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                <div class="product-image">
                    ...
                    <ul class="social">
                        <li><a href="{{route('product.details',['slug'=>$product->slug])}}" data-tip="Quick View"><i class="fa fa-search"></i></a></li>
                        <li><a href="" data-tip="checkout with cart" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->sale_price}})"><i class="fas fa-shopping-bag"></i></a></li>
